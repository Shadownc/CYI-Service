<template>
  <AppPage show-footer>
    <div class="flex">
      ...
      <n-card class="ml-12 w-70%" title="✨ 欢迎使用 Vue Naive Admin 图床管理">
        ...
        <p class="opacity-60">
          ...
          Unocss，后端使用 Cloudflare Workers + KV + D1，简单易用，赏心悦目！！
        </p>
        <footer class="mt-12 flex items-center justify-end">
          ...
          <n-button
            ...
            class="ml-12"
            tag="a"
            href="https://github.com/Shadownc"
            target="__blank"
          >
            代码仓库
          </n-button>
    ...
    <n-card class="mt-12" title="⚡️ 趋势" segmented>
      <div class="h-400 text-center">
        <n-image width="100%" height="100%" src="https://api.star-history.com/svg?repos=Shadownc/CYI-Service&type=Date" />
      </div>
    </n-card>
  </AppPage>
</template>
